        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="cart" items="${list.rows}">
                <tr>
                    ...
                    <td><c:out <form action="CartServlet" method ="post" type ="text" value="${cart.Quantity}" /></td>
                    <td><image  height="600px" width="700px" src="<c:out value="${cart.Image}"/>"/></td>
                     <td><c:out value="${cart.Price}" /></td>
                     <td><form action="Delete" method="post"><input type="submit" value="Remove from cart"></form></td>
                </tr>
            </c:forEach>
